...
function getPattern(language) {
	...
	if (language == 'en') {
		...
		patternData = [
			...
			{id: 4, stitches: 5, desc: '', comment: 'repeat 3th row'},
			...
			{id: 15, stitches: 5, desc: '', comment: 'repeat 3th row'},
			{id: 16, stitches: 5, desc: '', comment: 'repeat 3th row'},
			{id: 17, stitches: 5, desc: '', comment: 'repeat 3th row'},
			{id: 18, stitches: 5, desc: '', comment: 'repeat 3th row'},
			{id: 19, stitches: 5, desc: '', comment: 'repeat 3th row'},
			{id: 20, stitches: 5, desc: '', comment: 'repeat 3th row'},
			...
			{id: 31, stitches: 5, desc: '', comment: 'repeat 3th row'},
			{id: 32, stitches: 5, desc: '', comment: 'repeat 3th row'},
			{id: 33, stitches: 5, desc: '', comment: 'repeat 3th row'},
			{id: 'Cinch Band', stitches: 6, desc: 'ch 7', comment: 'Sc in 2nd ch from hook and in each ch across. Fasten off, leaving long tail for sewing'},
			{id: 'Neck Band', stitches: 'Work as many ch sts as needed to fit comfortably around wearer’s neck', desc: '', comment: 'Sc in 2nd ch from hook and in each ch across; do not turn.'},
			{id: 'Buttonhole Loop', stitches: 5, desc: 'ch 5', comment: 'Join with slip st in last st of Row 1. Fasten off.'},
		];
		...
		patternData = [
			...
			{id: 'Завязка', stitches: 6, desc: '7 вп', comment: 'сбн во 2 петлю от крючка и в каждую последующую петлю до конца - 6 сбн. Закрепляем, оставляя длинный хвостик для пришивания'},
			{id: 'Шейный ремешок', stitches: 'аберите столько петель, сколько необходимо, чтобы было удобно носить бабочку на шее.', desc: '', comment: 'сбн во 2-ю петлю от крючка и в каждую петлю до конца.'},
			{id: 'Перемычка', stitches: 5, desc: '5 вп', comment: 'Замкните ряд. Закрепите'}
		];
